...
import com.rezolve.web.ic.model.RxpTargetData;
...
public class RxpCreateEngagementPage extends BasePage {
    ...
    public RxpCreateEngagementPage enterEngagementName(TestData testData){
        engagementNameInput.enterText(testData.getTestData(RxpEngagementData.class).getName());
    return this;
    }
    ...
    public RxpCreateEngagementPage searchAndSelectGivenTarget(TestData testData){
        RxpTargetData rxpTargetData = testData.getTestData(RxpTargetData.class);
         savedTargetSearchBox.enterText(rxpTargetData.getName());
         elementByXpath("(//h3[text()=' "+rxpTargetData.getName()+" '])[1]").waitUntilElementVisible(30).click();
