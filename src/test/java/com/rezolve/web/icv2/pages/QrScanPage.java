    ...
    public QrScanPage selectGivenQRCode(TestData testData){
     //   fileUpload.fileUploadSendkeys("/Users/arulchristopher/downloads/"+testData.getTestData(RxpEngagementData.class).getName()+".png");
        ...
        if (getPlatformName().toLowerCase().equals("mac")){
           fileUpload.fileUploadSendkeys("/Users/test1/downloads/"+testData.getTestData(RxpEngagementDataICv2.class).getName()+".png");
       }else {
           fileUpload.fileUploadSendkeys("C:\\Users\\hello\\downloads\\" + testData.getTestData(RxpEngagementDataICv2.class).getName() + ".png");
       }
       Thread.sleep(10000);
