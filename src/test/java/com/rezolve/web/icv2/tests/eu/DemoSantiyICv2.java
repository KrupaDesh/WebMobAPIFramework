...
public class DemoSantiyICv2 extends BaseTest {

    @SneakyThrows
    @Test(priority = 1, description = "Buy the product by using Facebook Account", groups = {"ICv2_EU_Desk_Regression_Demo","ICv2_EU_Mobile_Regression_Demo"})
    ...
    @SneakyThrows
    @Test(priority = 1,description = "Buy the product then Collect in store by using Facebook Account with credit card", groups = {"ICv2_EU_Desk_Regression_Demo","ICv2_EU_Mobile_Regression_Demo"})
    ...
    @Test( priority = 3, description = "Add new Address and validate", groups = {"ICv2_EU_Desk_Regression_Demo","ICv2_EU_Mobile_Regression_Demo"})
    ...
    //@Test(dependsOnMethods ="addNewGeneralAddress", description = "User should be able to delete an existing saved address",groups = {"ICv2_EU_Desk_Regression_Demo","ICv2_EU_Mobile_Regression_Demo"})
    @Test(priority = 4, description = "User should be able to delete an existing saved address",groups = {"ICv2_EU_Desk_Regression_Demo","ICv2_EU_Mobile_Regression_Demo"})
...
@SneakyThrows
    @Test(priority = 4,description = "Add New Card and Delete Added Card", groups = {"ICv2_EU_Desk_Regression_Demo","ICv2_EU_Mobile_Regression_Demo"})
    ...
    @Test(priority = 5,description = "Switching between payment methods", groups = {"ICv2_EU_Desk_Regression_Demo","ICv2_EU_Mobile_Regression_Demo"})
    ...
    @SneakyThrows
    @Test(priority = 5,description = "Switching between delivery methods by using Facebook Account", groups = {"ICv2_EU_Desk_Regression_Demo","ICv2_EU_Mobile_Regression_Demo"})
